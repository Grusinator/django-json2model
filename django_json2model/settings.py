"""
Django settings for django_json2model project.
...
SECRET_KEY = 'gvl*ns&mo%uy7*347ngcsi#%&t%^bp+8xkgj7=e=q9%k=$6*ib'
...
ROOT_URLCONF = 'django_json2model.urls'
...
WSGI_APPLICATION = 'django_json2model.wsgi.application'
